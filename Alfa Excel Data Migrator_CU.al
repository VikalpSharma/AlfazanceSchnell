codeunit 70140953 "Alfa Excel Data Migrator"
{
    ...
    begin
        ...
        InsertPackageTableIUOM(DataMigrationSetup);
        InsertPackageTableItemCategories(DataMigrationSetup);
    ...
    begin
        ...
        InsertPackageFieldsIUOM;
        InsertPackageFieldsItemCategories;
    end;

    local procedure InsertPackageTableItemCategories(var DataMigrationSetup: Record "Data Migration Setup")
    var
        ConfigPackageTable: Record "Config. Package Table";
        ConfigTableProcessingRule: Record "Config. Table Processing Rule";
    begin
        ConfigPackageManagement.InsertPackageTable(ConfigPackageTable, PackageCodeTxt, DATABASE::"Item Category");
    ...
    local procedure InsertPackageFieldsItemCategories()
    var
        ConfigPackageField: Record "Config. Package Field";
    begin
        ConfigPackageField.SETRANGE("Package Code", PackageCodeTxt);
        ConfigPackageField.SETRANGE("Table ID", DATABASE::"Item Category");
        ConfigPackageField.DELETEALL(TRUE);

        InsertPackageField(DATABASE::"Item Category", 1, 1);     // Code
        InsertPackageField(DATABASE::"Item Category", 2, 2);     // Parent Category
        InsertPackageField(DATABASE::"Item Category", 3, 3);     // Description
        InsertPackageField(DATABASE::"Item Category", 9, 4);     // Indentation
        InsertPackageField(DATABASE::"Item Category", 10, 5);     // Presentation Order

    end;

    local procedure InsertPackageTableIUOM(var DataMigrationSetup: Record "Data Migration Setup")
    var
        ConfigPackageTable: Record "Config. Package Table";
        ConfigTableProcessingRule: Record "Config. Table Processing Rule";
    begin
        ConfigPackageManagement.InsertPackageTable(ConfigPackageTable, PackageCodeTxt, DATABASE::"Item Unit of Measure");
        ConfigPackageTable."Data Template" := DataMigrationSetup."Default Customer Template";
        ConfigPackageTable.MODIFY;
        ConfigPackageManagement.InsertProcessingRuleCustom(
          ConfigTableProcessingRule, ConfigPackageTable, 100000, CODEUNIT::"Excel Post Processor");
    ...
    local procedure InsertPackageFieldsIUOM()
    var
        ConfigPackageField: Record "Config. Package Field";
    begin
        ConfigPackageField.SETRANGE("Package Code", PackageCodeTxt);
        ConfigPackageField.SETRANGE("Table ID", DATABASE::"Item Unit of Measure");
        ConfigPackageField.DELETEALL(TRUE);

        InsertPackageField(DATABASE::"Item Unit of Measure", 1, 1);     // Item No.
        InsertPackageField(DATABASE::"Item Unit of Measure", 2, 2);     // Code
        InsertPackageField(DATABASE::"Item Unit of Measure", 3, 3);     // Qty. per Unit of Measure 
    ...
    begin
        ...
        InsertPackageField(DATABASE::"G/L Account", 14, 13);   // Direct Posting
        InsertPackageField(DATABASE::"G/L Account", 57, 14);   // VAT Bus. Posting Group
        InsertPackageField(DATABASE::"G/L Account", 58, 15);   // VAT Prod. Posting Group
    end;
